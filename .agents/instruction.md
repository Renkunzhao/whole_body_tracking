...
- IsaacLab Phase 1 single-condition script: `scripts/isaaclab_trampoline_phase1_condition.py`
- IsaacLab Phase 1 driver: `scripts/isaaclab_trampoline_phase1_sweep.py`
- Existing policy evaluation script: `scripts/rsl_rl/eval-rebounce.py`
- Related deployment/explanation doc: `.codex/skills/trampoline/task6-mujoco-deploy.md`
...
- Test conclusions (2026-05-21, res=15, E=8e6, ed=0.01, tm=15, ball_mass=16.67 kg, ball_height=1.0 m, `--no-video`)
