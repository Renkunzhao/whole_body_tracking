...
The input is produced by ``scripts/rsl_rl/play-rebounce.py --joint_vel_csv``.
It writes phase-split velocity statistics and plots useful for selecting a
joint-velocity deadband.
"""
