...
\begin{aligned}
    R_t = \Delta t \Big(
        ...
        +50\,r^{\mathrm{apex}}_t \\
        &-2.5\times10^{-2}\,r^{\mathrm{energy}}_t \\
...
reset environments. With the current energy weight, a typical sparse energy
pulse of $W^{+}/h^{*}\approx 150$ contributes
\[
    -2.5\times10^{-2}\cdot150\cdot0.02/20 \approx -0.00375
\]
...
With the current $\Delta t=0.02$ s, the current positive-work weight is
\[
    w_{\mathrm{energy}} = -2.5\times10^{-2}.
\]
...
The current positive-work run shows the intended first-order behavior: the
