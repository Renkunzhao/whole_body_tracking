...
# This script only needs robot/assets utilities. Skipping task auto-registration
# avoids unrelated Gym config import failures during smoke tests.
os.environ.setdefault("WHOLE_BODY_TRACKING_IMPORT_TASKS", "0")
